...
vector<string> ValidChecker::parseString(string source, string delimiter)
{
...
bool ValidChecker::IsNumberString(const string& str)
{
...
bool ValidChecker::IsCapitalString(const string& Str)
{
...
bool ValidChecker::checkEmployeeNum(const string& EmployeeNum)
{
...
bool ValidChecker::checkEmployeeName(const string& EmployeeName)
{
	int space = 0, loop = 0;
...
bool ValidChecker::checkCL(const string& ClType)
{
	if (ClType == "CL1" || ClType ==  "CL2" || ClType == "CL3" || ClType == "CL4") return true;
	return false;
}

bool ValidChecker::checkPhoneNum(const string& PhoneNum)
{
	ValidChecker checker;
...
bool ValidChecker::checkBirthday(const string& Birthday)
{
	ValidChecker checker;
...
bool ValidChecker::checkCertiGrade(const string& CertiGrade)
{
	if (CertiGrade == "ADV" || CertiGrade ==  "PRO" || CertiGrade == "EX") return true;
	return false;
}

int ValidChecker::convertColumnStrToInt(const string& column)
{
...
bool ValidChecker::checkOpt1(const string& Opt1)
{
	if (Opt1 == "-p" || Opt1 == " ") return true;
	return false;
}

bool ValidChecker::checkOpt2(const string& Opt2)
{
	if (Opt2 == "-f" || Opt2 == "-l" || Opt2 == "-m" || Opt2 == "-y" || Opt2 == "-d" || Opt2 == " ") return true;
	return false;
}

bool ValidChecker::checkOpt3(const string& Opt3)
{
	if (Opt3 == " ") return true;
	return false;
}

bool ValidChecker::checkOptName(const string& OptName)
{
...
bool ValidChecker::checkOptPhoneNum(const string& OptPhoneNum)
{
...
bool ValidChecker::checkOptY_Birthday(const string& OptY_Birthday)
{
...
bool ValidChecker::checkOptM_Birthday(const string& OptM_Birthday)
{
...
bool ValidChecker::checkOptD_Birthday(const string& OptD_Birthday)
{
...
bool ValidChecker::checkOptNone(const string& OptNone1, const string& OptNone2)
{
...
bool ValidChecker::checkSrchCond(const string& InputStr)
{
	int checkedCnt = 1;
...
bool AddValidChecker::checkValid(const string& InputStr)
{
	int checkedPara = 0;
...
bool DelValidChecker::checkValid(const string& InputStr)
{
	vector<string> strList = parseString(InputStr, ",");
...
bool SchValidChecker::checkValid(const string& InputStr)
{
	vector<string> strList = parseString(InputStr, ",");
...
bool ModValidChecker::checkValid(const string& InputStr)
{
	vector<string> strList = parseString(InputStr, ",");
